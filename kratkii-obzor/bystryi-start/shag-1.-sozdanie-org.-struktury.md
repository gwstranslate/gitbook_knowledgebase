...
3. Как только вы создали Организацию, вам будет необходимо добавить сотрудников, которые работают в вашей Организации, а также распределить соответствующую ответственность каждого и выдать необходимые доступы для того чтобы они также могли начать пользоваться системой
   * Подробности по полной настройке рабочего персонала (_физические лица_, _штат, пользователи, роли_) вы можете ознакомиться, [перейдя по ссылке](broken-reference)

По окончанию прохождения всех вышеуказанных пунктов, вам будет доступна полная картина вашей организационной структуры.&#x20;
...
* Подробности об разделении понятий **Администрирование и Организации**, вы можете получить, перейдя по ссылке.
{% endhint %}
...
{% tab title="Доступ на просмотр и действия кнопок" %}
